...
<html>
  <head>
    <title>Invoice | Flatty - Flat Administration Template</title>
                ...
                <div class='col-sm-12'>
                  <div class='page-header'>
                    ...
                    <div class='pull-right'>
                      <div class='btn-group'>
                                  <a class="btn" href="#"><i class='icon-print'></i>
                        Print
                        </a>
                    ...
                    <div class='box-content box-double-padding'>
                      ...
                      <div class='row'>
                        ...
                        <div class='col-sm-4 info'>
                          <div class='lead text-muted'>Info</div>
                          Invoice date:
                              ...
                              <table class='table table-striped table-hover table-bordered'>
                                ...
                                <tbody>
                                  <tr>
                                    ...
                                    <td>
                                      <div class='text-right'>$302.00</div>
                                    </td>
                                    <td>
                                      <div class='text-right'>$302.00</div>
                                    </td>
                                  ...
                                  <tr>
                                    <td>AO9</td>
                                    <td>Labore ut rerum tempora</td>
                                    <td>
                                      <div class='text-center'>4</div>
                                    </td>
                                    <td>
                                      <div class='text-right'>$486.00</div>
                                    </td>
                                    <td>
                                      <div class='text-right'>$1,944.00</div>
                                    </td>
                                  </tr>
                                  <tr>
                                    <td>AO3</td>
                                    <td>Dignissimos ut assumenda numquam</td>
                                    <td>
                                      <div class='text-center'>1</div>
                                    </td>
                                    <td>
                                      <div class='text-right'>$360.00</div>
                                    </td>
                                    <td>
                                      <div class='text-right'>$360.00</div>
                                    </td>
                                  ...
                                  <tr>
                                    <td>AO3</td>
                                    <td>Vel sit a nemo</td>
                                    <td>
                                      <div class='text-center'>4</div>
                                    </td>
                                    <td>
                                      <div class='text-right'>$250.00</div>
                                    </td>
                                    <td>
                                      <div class='text-right'>$1,000.00</div>
                                    </td>
                                  </tr>
                                  <tr>
                                    <td>AO5</td>
                                    <td>Aspernatur voluptas et ullam</td>
                                    <td>
                                      <div class='text-center'>2</div>
                                    </td>
                                    <td>
                                      <div class='text-right'>$377.00</div>
                                    </td>
                                    <td>
                                      <div class='text-right'>$754.00</div>
                                    </td>
                                  </tr>
                                  <tr>
                                    <td>AO5</td>
                                    <td>Illo quia aliquid consequuntur</td>
                                    <td>
                                      <div class='text-center'>3</div>
                                    </td>
                                    <td>
                                      <div class='text-right'>$107.00</div>
                                    </td>
                                    <td>
                                      <div class='text-right'>$321.00</div>
                                    </td>
                                  </tr>
                                </tbody>
                              </table>
                      ...
                      <div class='row'>
                        <div class='col-sm-12'>
                          <div class='well comment'>
                            Velit eum et voluptatibus ut iusto possimus mollitia
                          </div>
                        </div>
                      </div>
                    </div>
